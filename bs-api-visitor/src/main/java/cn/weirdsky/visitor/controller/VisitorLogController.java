...
import cn.weirdsky.visitor.service.VisitorLogService;
...
public class VisitorLogController {
    ...
    public R getBySearch(@RequestParam("queryWrapper") String queryWrapper) {
        return R.ok(visitorLogService.getBySearch(queryWrapper));
    }

    @PostMapping("/getLogBySpaceQuery")
    public R getLogBySpace(@RequestParam("queryWrapper") String queryWrapper) {
        return R.ok(visitorLogService.getLogBySpace(queryWrapper));
    }
}
