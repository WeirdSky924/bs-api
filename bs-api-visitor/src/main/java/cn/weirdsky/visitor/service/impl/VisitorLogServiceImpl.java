...
public class VisitorLogServiceImpl implements VisitorLogService {
    ...
    @Override
    public List<VisitorLogQo> getBySearch(String queryWrapper) {
        return visitorLogMapper.getBySearchString(queryWrapper);
    }
    ...
    @Override
    public List<VisitorLogQo> getLogBySpace(String queryWrapper) {
        return visitorLogMapper.getLogBySpaceString(queryWrapper);
    }
