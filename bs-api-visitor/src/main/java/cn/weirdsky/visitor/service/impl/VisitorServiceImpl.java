...
import cn.weirdsky.entity.entity.importExcel.VisitorImportExcel;
...
import cn.weirdsky.mapper.mapper.VisitorMapper;
...
public class VisitorServiceImpl implements VisitorService {
    ...
    @Override
    public List<Visitor> getBySearch(QueryWrapper queryWrapper) {
        return null;
    }
...
//    }
    ...
    @Override
    public List<VisitorLogVo> visitorStatisticsGroupByDate() {
        return visitorMapper.visitorStatisticsGroupByDate();
    }

    @Override
    public Visitor getByVisitorName(String visitorName) {
        return visitorMapper.getByVisitorName(visitorName);
    }

    @Override
    public List<DepartmentVo> visitorStatisticGroupByDepartment() {
        return visitorMapper.visitorStatisticGroupByDepartment();
    }

    @Override
    public List<Visitor> getVisitorByDepartmentName(String departmentName) {
        return visitorMapper.getVisitorByDepartmentName(departmentName);
    }

    @Override
    public List<Visitor> getListBySearch(String queryWrapper) {
        return visitorMapper.getListBySearchString(queryWrapper);
    }
