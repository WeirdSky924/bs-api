package cn.weirdsky.visitor.interceptor;


import cn.weirdsky.entity.entity.Code;
import cn.weirdsky.entity.entity.LoginUser;
import cn.weirdsky.utils.util.TokenUtil;
import cn.weirdsky.visitor.config.WhitelistConfig;
import cn.weirdsky.visitor.exception.MySessionException;
...
public class CommonInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (whitelistConfig.getPorts().stream().anyMatch(request.getRequestURL().toString()::contains)){
            logger.info("===>loginUser: WhiteList");
            return true;
        }
